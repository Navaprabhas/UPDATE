...
export const CircularTestimonials = ({
  ...
  const arrowButtonsStyles: React.CSSProperties = {
    display: "flex",
    gap: "1.5rem",
    paddingTop: window.innerWidth >= 768 ? "0" : "3rem",
  };
      ...
      <div style={gridStyles}>
        ...
        <div style={imageContainerStyles} ref={imageContainerRef}>
          {testimonials.map((testimonial, index) => (
            <img
              ...
              style={{...imageStyles, ...getImageStyle(index)}}
              data-index={index}
            />
          ))}
        </div>
        ...
        <div style={contentStyles}>
          <AnimatePresence mode="wait">
            ...
            >
              <h3
                style={{ ...nameStyles, color: colorName, fontSize: fontSizeName }}
              >
                {activeTestimonial.name}
              </h3>
              <p
                style={{ ...designationStyles, color: colorDesignation, fontSize: fontSizeDesignation }}
              >
                {activeTestimonial.designation}
              </p>
              <motion.p
                style={{ ...quoteStyles, color: colorTestimony, fontSize: fontSizeQuote }}
              >
